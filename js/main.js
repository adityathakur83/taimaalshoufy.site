    ...
    document.querySelectorAll(".reel").forEach(r => {
      r.addEventListener("click", () => {
        ...
        box.innerHTML = src
          ...
          : `<div style="display:grid;place-items:center;height:100%;color:#f4f0e8;text-align:center;padding:2rem;font-family:'Cormorant Garamond',serif;font-size:1.3rem;">Video coming soon —<br>replace data-video with your reel URL</div>`;
